...
SRC_URL=https://raw.githubusercontent.com/forjustice/jsproxy/$JSPROXY_VER
BIN_URL=https://raw.githubusercontent.com/forjustice/jsproxy-bin/master
ZIP_URL=https://codeload.github.com/forjustice/jsproxy/tar.gz
...
main() {
  ...
  log "安装完成。后续维护参考 https://github.com/forjustice/jsproxy"
}
